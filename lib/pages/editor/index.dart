...
class _EditorPageState extends State<EditorPage> {
  ...
  Widget build(BuildContext context) {
    const document = r'''![mockingbird](https://user-images.githubusercontent.com/12797292/131216767-6eb251d6-14fc-4951-8324-2722f0cd4c63.jpg)
...
final editorState = EditorState(
  document: markdownToDocument(document),
);
    return Scaffold(
      body: AppFlowyEditor(
