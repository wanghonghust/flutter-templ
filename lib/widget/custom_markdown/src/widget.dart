...
import 'package:kms/widget/custom_markdown/src/toc.dart';
...
abstract class MarkdownWidget extends StatefulWidget {
  ...
  @protected
  Widget build(
      BuildContext context, List<Widget>? children, List<Toc>? tocList);
...
class _MarkdownWidgetState extends State<MarkdownWidget>
  ...
  void _parseMarkdown() {
    ...
    final List<md.Node> astNodes = document.parse(widget.data);
    ...
    var pair = builder.build(astNodes);
    _children = pair.first;
    _tocList = pair.second;
  }
  ...
  Widget build(BuildContext context) =>
      widget.build(context, _children, _tocList);
}
